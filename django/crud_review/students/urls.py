...
urlpatterns = [
    ...
    # path('create/', views.create, name= 'create'),           # GET,POST /students/create/ (x)
...
# 
# -장점
# 1. 주소의 변경이 필요할 때, urls.py
# 2. 마지막 '/'를 빼먹는 실수를 차단할 수 있다.
...
# GET   /students/2/edit/ => 수정 페이지 부여줌
# POST  /students/2/edit/ => 수정 작업 수행

# ex)
# GET     /users/1 => user 1번 가져옴
# PUT     /users/1 => user 1번 가져옴
# GET     /users/1 => user 1번 가져옴
# 
# 
